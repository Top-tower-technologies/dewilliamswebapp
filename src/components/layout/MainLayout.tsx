...
const MainLayout = ({ children, navigation, buttonText, handleClick, buttonVisible, customButton }: { children: ReactNode, navigation?: any, buttonText: any, handleClick?: any, buttonVisible?: boolean, customButton?: any }) => {
    return (
        <>
