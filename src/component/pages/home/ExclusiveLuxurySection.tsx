...
const ExclusiveLuxurySection = () => {
  return (
    <section className="relative w-full h-[500px] md:h-[600px]">
      ...
      {/* Overlay box */}
      <div className="absolute top-10 left-6 md:top-20 md:left-16 bg-white p-6 md:p-10 max-w-xs shadow-xl z-10">
...
export default ExclusiveLuxurySection;
