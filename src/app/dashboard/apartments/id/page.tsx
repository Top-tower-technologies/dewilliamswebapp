...
const page = () => {
    ...
    return (
        <MainLayout navigation={<PageHeader page='Apartments' icon={false}/>} customButton={<Button className='bg-black text-white' onClick={() => { setOpen(true) }}>Check Out Guest</Button>} buttonText={""} buttonVisible={true}>
